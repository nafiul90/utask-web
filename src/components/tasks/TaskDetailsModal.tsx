...
export const TaskDetailsModal = ({
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR(["task", taskId, token], ([_, id, t]) => Api.getTask(t, id), {
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="flex flex-col lg:flex-row">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <span className="text-white block py-2">
            ...
            <div className="w-full lg:w-[400px] flex flex-col bg-slate-900/30 border-t lg:border-t-0 border-white/10">
              <div className="p-6">
                <h3 className="font-semibold text-slate-300 mb-4 uppercase tracking-wider text-xs">
                  Comments
                </h3>
